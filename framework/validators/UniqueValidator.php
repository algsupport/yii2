...
class UniqueValidator extends Validator
{
	 ...
	 */
	public string|array|null $targetAttribute;
	/**
	 ...
	 */
	public string|Closure|array $filter;
	/**
	 ...
	 *
	 * When validating multiple attributes, it may contain the following placeholders:
	 *
	 ...
	 * @since 2.0.11
	 */
	public string $targetAttributeJunction = 'and';
	/**
	 * @var bool whether this validator is forced to always use master DB
	 * @since 2.0.14
	 */
	public bool $forceMasterDb = true;
	...
	public function validateAttribute($model, $attribute): void
	{
		...
		/* @var $targetClass class-string<ActiveRecordInterface> */
	 ...
	 *
	 * @param array|string $targetAttribute the name of the [[\yii\db\ActiveRecord|ActiveRecord]] attribute that
	 ...
	 * @throws InvalidConfigException
	 */
	private function prepareConditions(array|string $targetAttribute, Model $model, string $attribute): array
	{
	...
	/**
	 * @param Model $model the data model to be validated
	 * @return string|null Target class name
	 */
	 ...
	 * @throws InvalidConfigException
	 */
	private function applyTableAlias(ActiveQuery $query, array $conditions): array
	{
	 ...
	 * @throws InvalidConfigException
	 */
	private function modelExists(string $targetClass, array $conditions, Model $model): bool
	{
		/** @var ActiveRecordInterface|BaseObject $targetClass $query */
		$query = $this->prepareQuery($targetClass, $conditions);

		if (!$model instanceof ActiveRecordInterface || $model->getIsNewRecord() || $model::class !== $targetClass) {
	 ...
	 */
	private function prepareQuery(ActiveRecordInterface $targetClass, array $conditions): ActiveQueryInterface|ActiveQuery
	{
